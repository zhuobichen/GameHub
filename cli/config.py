...
EMAIL_PORT = int(os.getenv("GAMEHUB_EMAIL_PORT", "587"))
EMAIL_USER = os.getenv("GAMEHUB_EMAIL_USER", "")
EMAIL_PASSWORD = os.getenv("GAMEHUB_EMAIL_PASSWORD", "")
EMAIL_TO = os.getenv("GAMEHUB_EMAIL_TO", "")
